...
QtObject {
    ...
    property string orange: "#6539AB"
    property string purple: "#6539AB"
    ...
    property string _b_errorColor: "#5A18C4"
    ...
    property string _b_buttonBackgroundColor: "#5A18C4"
    property string _b_buttonBackgroundColorHover: "#4F14AD"
    ...
    property string _w_errorColor: "#5A18C4"
    ...
    property string _w_buttonBackgroundColor: "#5A18C4"
    property string _w_buttonBackgroundColorHover: "#4F14AD"
    ...
    property string _w_menuButtonImageRightColorActive: "#5A18C4"
